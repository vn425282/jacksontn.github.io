...
$("#fullpage").fullpage({
    ...
    menu: "#menu",
    afterSlideLoad: function(e, n, t, o) {
        "fourthSection" == e && 1 == o && ($.fn.fullpage.setAllowScrolling(!1, "up"), $header_top.css("background", "transparent"), $nav.css("background", "transparent"), $(this).css("background", "#374140"), $(this).find("h2").css("color", "white"), $(this).find("h3").css("color", "white"), $(this).find("p").css({
            color: "#ff3e55",
            opacity: 1,
            transform: "translateY(0)"
        }))
    },
    onSlideLeave: function(e, n, t, o) {
        "fourthSection" == e && 1 == t && ($.fn.fullpage.setAllowScrolling(!0, "up"), $header_top.css("background", "rgba(0, 47, 77, .3)"), $nav.css("background", "rgba(0, 47, 77, .25)"))
    }
})
